...
function normalizePhoneNumber(raw) {
  ...
  // Convert Indian 10-digit number to 91xxxxxxxxxx
  if (clean.length === 10) {
    clean = `91${clean}`;
  }

  // Handle 0-prefixed Indian number like 09110775576
          ...
          {businessPhone ? (
            <div className="mt-6">
              <a
                ...
                className="block w-full px-6 py-3 text-sm font-bold text-center transition active:scale-[0.98]"
                style={{
